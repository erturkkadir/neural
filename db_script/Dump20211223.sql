...
) ENGINE=InnoDB AUTO_INCREMENT=14718595 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1554160 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE DEFINER=`kadir`@`%` FUNCTION `target_node`(
    ...
    DETERMINISTIC
BEGIN
  RETURN 1+floor(pmin+RAND()*(pmax-pmin));
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
	...
	while y<(py-1) do 		/* No outward connections in y on the last layer	*/ 	
    	while x<(px-1) do 	/* No outward connections in x on the last latyer	*/         	
            ...
            while i<n_conn do 
                ...
                if (to_x>0 and to_y>0 and to_z>0 and x<px and y<py and z<pz) then 
...
-- Dump completed on 2021-12-23 10:50:54
